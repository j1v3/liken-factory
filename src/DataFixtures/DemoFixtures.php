...
class DemoFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $menu1->setRank(1);
        $menu1->setOwner($this->userRepository->findByEmail("webmaster@likenfactory.com"));
        $menu1->setRole($this->roleRepository->findByName("public"));
        ...
        $menu2->setRank(2);
        $menu2->setOwner($this->userRepository->findByEmail("webmaster@likenfactory.com"));
        $menu2->setRole($this->roleRepository->findByName("public"));
        ...
        $menu3->setRank(3);
        $menu3->setOwner($this->userRepository->findByEmail("webmaster@likenfactory.com"));
        $menu3->setRole($this->roleRepository->findByName("private"));
        ...
        $menu4->setRank(4);
        $menu4->setOwner($this->userRepository->findByEmail("admin@likenfactory.com"));
        $menu4->setRole($this->roleRepository->findByName("admin"));
        ...
        $subMenu1->setRank("1");
        $subMenu1->setOwner($this->userRepository->findByEmail("webmaster@likenfactory.com"));
        $subMenu1->setRole($this->roleRepository->findByName("public"));
        $subMenu1->setMenu($this->menuRepository->findByName("Menu2"));
        ...
        $subMenu2->setRank("2");
        $subMenu2->setOwner($this->userRepository->findByEmail("webmaster@likenfactory.com"));
        $subMenu2->setRole($this->roleRepository->findByName("private"));
        $subMenu2->setMenu($this->menuRepository->findByName("Menu3"));
        ...
        $subSubMenu1->setOwner($this->userRepository->findByEmail("webmaster@likenfactory.com"));
        $subSubMenu1->setRole($this->roleRepository->findByName("private"));
        $subSubMenu1->setSubMenu($this->subMenuRepository->findByName("SubMenu2"));
        ...
        ");
        $content1->setOwner($this->userRepository->findByEmail("webmaster@likenfactory.com"));
        $content1->setRole($this->roleRepository->findByName("public"));
        $content1->setMenu($this->menuRepository->findByName("Menu1"));
        ...
        <div>Aliquam erat volutpat. Nulla sed tristique quam. Mauris dictum egestas eleifend. Phasellus ultricies malesuada ex id accumsan. Suspendisse ac malesuada neque. Aenean enim orci, viverra nec congue nec, imperdiet quis lorem. Mauris venenatis placerat velit id tempus. Nullam tincidunt facilisis massa, quis posuere urna cursus dapibus. Nunc tristique elementum massa, non malesuada nibh efficitur sed. Sed nec rutrum purus. Praesent placerat ipsum a congue tincidunt. Etiam ultricies in urna eget commodo. Duis non metus aliquet purus auctor aliquam.</div>
        ");
        $content2->setOwner($this->userRepository->findByEmail("webmaster@likenfactory.com"));
        $content2->setRole($this->roleRepository->findByName("public"));
        $content2->setMenu($this->subMenuRepository->findByName("SubMenu2"));
        ...
        <div>Aliquam erat volutpat. Nulla sed tristique quam. Mauris dictum egestas eleifend. Phasellus ultricies malesuada ex id accumsan. Suspendisse ac malesuada neque. Aenean enim orci, viverra nec congue nec, imperdiet quis lorem. Mauris venenatis placerat velit id tempus. Nullam tincidunt facilisis massa, quis posuere urna cursus dapibus. Nunc tristique elementum massa, non malesuada nibh efficitur sed. Sed nec rutrum purus. Praesent placerat ipsum a congue tincidunt. Etiam ultricies in urna eget commodo. Duis non metus aliquet purus auctor aliquam.</div>
        ");
        $content3->setOwner($this->userRepository->findByEmail("webmaster@likenfactory.com"));
        $content3->setRole($this->roleRepository->findByName("public"));
        $content3->setSubMenu($this->subSubMenuRepository->findByName("SubSubMenu1"));
