...
final class Version20201031120433 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sub_sub_menu (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, role_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, rank INT NOT NULL, created_at DATETIME NOT NULL, uptaded_at DATETIME DEFAULT NULL, validated_at DATETIME DEFAULT NULL, deleted_At DATETIME DEFAULT NULL, is_active TINYINT(1) DEFAULT \'0\', INDEX IDX_E03C4B0B7E3C61F9 (owner_id), INDEX IDX_E03C4B0BD60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
