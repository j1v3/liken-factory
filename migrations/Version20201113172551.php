 ...
 */
final class Version20201113172551 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE sub_menu (id INT AUTO_INCREMENT NOT NULL, menu_id INT NOT NULL, owner_id INT NOT NULL, role_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, rank INT NOT NULL, created_at DATETIME NOT NULL, uptaded_at DATETIME DEFAULT NULL, validated_at DATETIME DEFAULT NULL, deleted_At DATETIME DEFAULT NULL, is_Active TINYINT(1) NOT NULL, INDEX IDX_5A93A552CCD7E912 (menu_id), INDEX IDX_5A93A5527E3C61F9 (owner_id), INDEX IDX_5A93A552D60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sub_sub_menu (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, role_id INT NOT NULL, sub_menu_id INT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, rank INT NOT NULL, created_at DATETIME NOT NULL, uptaded_at DATETIME DEFAULT NULL, validated_at DATETIME DEFAULT NULL, deleted_At DATETIME DEFAULT NULL, is_Active TINYINT(1) NOT NULL, INDEX IDX_E03C4B0B7E3C61F9 (owner_id), INDEX IDX_E03C4B0BD60322AC (role_id), INDEX IDX_E03C4B0BB30FB5E6 (sub_menu_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE survey (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, role_id INT NOT NULL, client_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, uptaded_at DATETIME DEFAULT NULL, validated_at DATETIME DEFAULT NULL, deleted_At DATETIME DEFAULT NULL, is_Active TINYINT(1) NOT NULL, INDEX IDX_AD5F9BFC7E3C61F9 (owner_id), INDEX IDX_AD5F9BFCD60322AC (role_id), INDEX IDX_AD5F9BFC19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
